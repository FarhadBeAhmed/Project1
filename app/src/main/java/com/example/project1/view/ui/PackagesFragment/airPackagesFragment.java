...
public class airPackagesFragment extends Fragment {
    TabLayout tabLayout;
    TabItem comboTab, dataTab, voiceTab;
    protected Toolbar toolbar;

    public airPackagesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_air_packages, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameLayout,new ComboPacksFragment("air"),"air").addToBackStack("air").commit();
